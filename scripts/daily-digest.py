...
**板块要求（全部必须输出，一个都不能少）：**
- highlight（今日看点）：选今天最重要的 3-4 件事，给一句话判断，语言精练有力
- china（国内）：4-6 条，政策/社会/经济/民生，优先引用 gov.cn/新华社/人民日报，有背景分析，每条都要有具体数据或细节
- world（国际）：4-6 条，重大事件/地区冲突/外交动态，优先引用 Reuters/AP/BBC，写清楚影响链和对中国的潜在影响
- military（军事与安全）：3-4 条，必须有自己的战略判断，不只复述；可涵盖演习、装备、地缘博弈
- economy（财经与市场）：4-6 条，宏观/股市/汇率/大宗商品，优先引用 Bloomberg/WSJ/财新/上交所/深交所数据，有操作层面的观察和风险提示
- tech（科技前沿）：4-6 条，AI/半导体/新能源技术为重点，优先引用 arXiv/TechCrunch/MIT，写清楚技术突破意味着什么
- entertainment（娱乐）：3-4 条，轻松但要有观点，涵盖影视/音乐/网红/综艺，不是流水账
- sports（体育）：3-4 条，重要赛事/中国运动员/赛事赛程，有结果有分析有期待
- auto（汽车）：4-5 条，新能源/传统车/行业竞争，有具体车型/销量/价格数据，优先引用 autohome/pcauto/reuters
- travel（旅游）：3-4 条，热门目的地/签证政策/出行攻略，优先引用 mafengwo/ctrip/官方旅游局，有实用信息
- jobs_hot（热门方向）：4-6 条，不限地区行业，列公司+岗位+薪资范围(如有)+核心亮点，选当下最热门/高薪/有代表性的岗位方向
